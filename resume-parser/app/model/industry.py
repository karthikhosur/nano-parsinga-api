...
def industry_class(text):
    try:
        ...
        information_technology_re= "embedded|network|technology|software|ajax|agile|android|c\#|c\+\+|css|haskell|software|html|java|javascript|julia|matlab|octave|perl|php|python|ruby|scala|information|sql|angular|asp.net|aws|cassandra|django|hadoop|hbase|hive|jquery|laravel|linux|mongodb|mysql|nltk|node|numpy|pandas|pig|postgresql|rails|react|spark|tensorflow|react"
