...
company_end_titles ="Corporation|Inc|INC|College|COLLEGE|Hospitality|UNIVERISTY|University|INSTITUTION|Institution|SCHOOL|Society|SOCIETY|School|Educational|EDUCATIONAL|Institute|Firm|Studios|University|Strategist|Partners|Strategies|Investments|Systems|Limited|LIMITED|LLC|llc|L\.L\.C|limited|LTD|Ltd|LTd|Ltd|Ldt|LDT|ltd|group|Group|GROUP|Bank|INVESTMENTS|SOLUTIONS|Financial Services|Scientific|Technology Solution|Technologies|Consulting|GLOBAL SERVICES|Agency|Corp|Scientific"
