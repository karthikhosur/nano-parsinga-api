...
def extract_present_employer(exp_text,terms):
    try:
        ...
        if present_employer =="":
            ...
            for i in range(len(terms)):
                if re.search(company_end_titles,terms[i]) and len(terms[i].split())<10:
