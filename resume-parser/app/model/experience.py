...
def duration_experience(terms,text):
    try:
        ...
        if len(text.split())<6 or total_dur == 0:
            text = text.lower()
            res = text.split()
            cnt = 0
            for i in range(len(res)):
