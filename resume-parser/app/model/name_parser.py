...
def name_from_title(terms):
    ...
    for i in range(5):
        ...
        if re.search(name_designation,temp):
            name_text = terms[i]
            name_text  = re.sub(",|\."," ",name_text)
            name_text = re.sub("PMP|PHD|MBA|MSC|CSM|CPA"," ",name_text.upper())
            break
    return name_text
