...
def extract_education(terms):
    try:
        ...
        degree_title = extract_degree_title(terms)
...
def extract_degree_title(terms):
    try:
        degree_title = ""
        for i in range(len(terms)):
