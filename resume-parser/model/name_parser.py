...
def name_extractor(terms,email_id,file_type):
    try:
        ...
        if re.search("docx|doc",file_type.lower()):
            name_text = docx_name_extractor(terms)

        # First check if the name in US names or not
        if name_text == "":
